...
func (s *KubeletServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringSliceVar(&s.ClusterDNS, "cluster-dns", []string{}, "IP address for a cluster DNS server.  If set, kubelet will configure all containers to use this for DNS resolution in addition to the host's DNS servers. comma seperated.")
