...
func (s *CMServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.IntVar(&s.DeletingPodsBurst, "deleting-pods-burst", 1, "Number of nodes on which pods are bursty deleted in case of node failure. For more details look into RateLimiter.")
	...
	fs.IntVar(&s.MaxDeadNodeCount, "maximum-dead-nodes", s.MaxDeadNodeCount, "Maximum number of nodes failures treated daily.  Default: 10.")
